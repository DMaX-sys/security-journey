...
- ## 🧪 Задание: Анализ оповещений

Дата: 3 ноября 2025  
Комната: Intro to Cyber Security  
Задача: Исследование оповещений о безопасности

### Вопрос 1:  
- **Вопрос**: What was the malicious IP address in the alerts?
- **Мой ответ**: 192.168.1.100
- **Обоснование**: Этот IP был указан в оповещении как источник подозрительной активности.

### Вопрос 2:  
- **Вопрос**: To whom did you escalate the alert with the malicious IP?
- **Мой ответ**: SOC Analyst
- **Обоснование**: В SOC-команде работают аналитики, которые реагируют на инциденты — именно им направляются оповещения.

### Вопрос 3:  
- **Вопрос**: What message did you get after blocking the IP address on the firewall?
- **Мой ответ**: Traffic blocked successfully
- **Обоснование**: Брандмауэр подтвердил, что трафик с опасного IP был заблокирован — это стандартное сообщение при успешной защите.

### Вывод:  
Анализ оповещений — ключевая задача SOC-аналитика. Я научился находить угрозы, понимать, кому сообщать, и проверять эффективность защиты.
